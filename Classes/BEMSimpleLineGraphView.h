...
@property (strong, nonatomic) UIColor *lineGlowColor;
...
- (nullable NSAttributedString *)lineGraph:(nonnull BEMSimpleLineGraphView *)graph labelOnXAxisForIndex:(NSInteger)index;

- (UIImage *)lineGraph:(nonnull BEMSimpleLineGraphView *)graph imageForPointAtIndex:(NSInteger)index;
